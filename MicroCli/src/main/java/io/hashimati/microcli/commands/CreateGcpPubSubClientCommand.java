...
@CommandLine.Command(name= "create-gcp-pubsub-client", aliases = {"pubsub-client", "pubsubClient", "PubSubClient"}, description = "To create GCP PubSub Client.")
public class CreateGcpPubSubClientCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        if(!configurationInfo
            ...
            try {
                MicronautProjectValidator.addDependency(path,FeaturesFactory.features(configurationInfo.getProjectInfo()).get("gcp-pubsub"));
...
//            MicronautProjectValidator.appendToProperties(messagingProperties);
        ...
        String className = PromptGui.inputText("className", "Enter the class name: ", "MyPubSubClient").getInput();
