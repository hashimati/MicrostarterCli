...
@Command(name="create-nats-listener", aliases = {"nats-listener", "natsListener"}, description = "To create Nats Listener component")
public class CreateNatsListenerCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        if(!configurationInfo
            ...
            try {
                MicronautProjectValidator.addDependency(path,FeaturesFactory.features(configurationInfo.getProjectInfo()).get("nats"));
