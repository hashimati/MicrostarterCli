...
public class UserRepository
{
    ...
    {
        log.info("Creating Collection for FruitRepository");
        return mongoClient.getDatabase("fruits")
                .getCollection("fruits", User.class);
    }
