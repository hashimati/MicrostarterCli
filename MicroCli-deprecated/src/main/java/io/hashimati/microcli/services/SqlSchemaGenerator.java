...
import static io.hashimati.microcli.services.TemplatesService.CONSTRAINT;
import static io.hashimati.microcli.services.TemplatesService.CREATE;
...
//        ${constrains}
        ...
        if((constraints.getV1()+constraints.getV2()).isEmpty())
            declaration.deleteCharAt(declaration.lastIndexOf(","));
        else
            declaration.append(constraints.getV1()).append(constraints.getV2());
...
//        declaration.deleteCharAt(declaration.lastIndexOf(","));
    ...
    public Tuple2<String, String> generateConstraints(Entity entity, ArrayList<EntityRelation> relations, HashMap<String, String> erMapper) throws IOException, ClassNotFoundException {
        ...
        System.gc();
        return Tuple2.tuple(attributes.toString(), constraints.lastIndexOf(",")>=0? constraints.deleteCharAt(constraints.lastIndexOf(",")).toString(): constraints.toString());
    }
